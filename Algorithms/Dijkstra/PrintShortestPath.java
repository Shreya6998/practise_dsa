...
public class PrintShortestPath {
    ...
    public static void main(String[] args) {
        ...
        runTest(graph1, 'A', 'F', List.of('A','B','E','F'));
        ...
        runTest(graph2, 'Z', 'E', List.of('Z','B','D','E'));
        ...
        runTest(graph3, 'A', 'D', List.of('A','B','C','D'));
        ...
        runTest(graph4, 'A', 'C', List.of()); // unreachable
    }
    ...
    private static void runTest(Map<Character, Map<Character,Integer>> graph,
                                Character src,
                                Character dest,
                                List<Character> expectedPath) {

        List<Character> path = shortestPath(graph, src, dest);
    ...
    private static List<Character> shortestPath(
            Map<Character, Map<Character,Integer>> graph,
            Character src, Character dest) {
        ...
        while(!pq.isEmpty()) {
            ...
            for(Map.Entry<Character,Integer> neighbor:neighbors.entrySet()) {
                ...
                if(newDist < distances.get(neighbor.getKey())) {
                    ...
                    parents.put(neighbor.getKey(),curr.node);
                }
            }
        }
